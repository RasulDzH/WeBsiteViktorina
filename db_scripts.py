...
def add_questions():
    questions = [
        ('Кто выиграл чемпионат мира по шахматам в 1975?', 'Карпов', 'Спасский', 'Фишер', 'Каспаров'),
        ('Кто получил Золотой мяч в 2010?', 'Месси', 'Роналду', 'Хави', 'Иньеста'),
        ('В какой весовой категории выступал Хабиб Нурмагомедов?', 'Легком весе', 'Полутяжелом весе', 'Полулегком весе', 'Средний вес'),
        ('Какая сборная по хоккею больше всего выигрывала золотые медали?', 'Россия/Канада', 'США', 'Канада', 'Финляндия'),

        ('Столица Бразилии?', 'Бразилиа', 'Сан-Паулу', 'Рио-де-Жанейро', 'Токио'),
        ('Столица Норвегии?', 'Осло', 'Хельсинки', 'Копенгаген', 'Варшава'),
        ('Столицей Уругвая?', 'Монтевидео', 'Санта-Мария', 'Асунсьон', 'Модейро')
        ('Столицей Бельгии?', 'Брюссель', 'Париж', 'Мадрид', 'Барселона')
